...
7. After the six values are received, the FIR filter calculates the result and transmits it through UART. The result will appear in the terminal's received data section.
